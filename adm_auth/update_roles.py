...
def update_roles(groups_by_role_name=None, role_names=None, verbose=None):
    ...
    Group permissions are usually edcs specific and the
    GroupPermissionsUpdater is usually callled from your main edcs app.
    """
    if verbose:
        sys.stdout.write(style.MIGRATE_HEADING("Updating roles:\n"))
    role_model_cls = django_apps.get_model("adm_auth.role")
