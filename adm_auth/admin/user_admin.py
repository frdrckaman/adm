...
from adm_auth.admin.user_profile_admin import UserProfileInline
from adm_dashboard.utils import select_edcs_template
...
class UserAdmin(BaseUserAdmin):
    ...
    def role(obj=None):
        ...
        template_obj = select_edcs_template("user_role_description.html", "adm_auth")
