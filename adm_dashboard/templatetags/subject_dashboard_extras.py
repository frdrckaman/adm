...
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/side-info-panel.html",
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/consent-panel.html",
#     takes_context=True,
# )
...
#     listboard_dashboard = "adm_dashboard:enroll-dashboard"
...
#     listboard_dashboard = "adm_dashboard:crf-list"
