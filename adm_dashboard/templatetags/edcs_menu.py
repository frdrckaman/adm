...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/template-theme-settings.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/main-menu.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/bottom-summary.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/top-button-icons.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/news-update.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/menu/summary-menu.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    f"adm_dashboard/bootstrap/labels/login_uat_label.html",
)
def login_uat_label():
    uat = False
