...
#
#
# @register.inclusion_tag(f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/copy_element.html")
# def copy_string_to_clipboard_button(value, index=None):
#     return dict(value=value, index=index)
#
#
# # @register.inclusion_tag(
# #     "adm_dashboard/index_link.html",
# #     takes_context=True,
# # )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/paginator/paginator_row.html",
#     takes_context=True,
# )
