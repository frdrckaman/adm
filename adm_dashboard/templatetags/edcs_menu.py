...
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/"
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/main-menu.html",
#     takes_context=True,
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/bottom-summary.html",
#     takes_context=True,
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/top-button-icons.html",
#     takes_context=True,
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/news-update.html",
#     takes_context=True,
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"menu/summary-menu.html",
#     takes_context=True,
# )
