...
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"buttons/screening_button.html",
# )
...
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"buttons/eligibility_button.html"
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/buttons/add_consent_button.html",
# )
...
#
# @register.inclusion_tag(
#     f"adm_dashboard/bootstrap{settings.EDCS_BOOTSTRAP}/" f"buttons/dashboard_button.html"
# )
